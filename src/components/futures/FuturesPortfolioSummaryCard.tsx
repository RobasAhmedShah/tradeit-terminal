  ...
  if (isEmpty) {
    return (
      <TouchableOpacity
        ...
        className="mx-4 mb-4 bg-app-card border border-app-border rounded-2xl p-4"
      >
        <View className="flex-row items-center">
          ...
          <View className="flex-1">
            <Text className="text-app-text text-sm font-bold">Futures Margin</Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex-row">
        <View className="flex-1">
          <Text className="text-app-muted text-[10px] mb-1">Available</Text>
          <Text className="text-app-text text-sm font-semibold">
            {formatFuturesPrice(marginAvailable)}
          </Text>
        </View>
        <View className="flex-1 items-center">
          <Text className="text-app-muted text-[10px] mb-1">Used</Text>
          <Text className="text-app-text text-sm font-semibold">
