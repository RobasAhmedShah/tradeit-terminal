...
export const StockOverviewCards: React.FC<StockOverviewCardsProps> = ({ stock }) => {
  return (
    <View className="px-4 py-6 space-y-6">
      ...
      {/* About Section */}
      <View>
        <Text className="text-white text-base font-bold mb-3">About the Company</Text>
      ...
      <View className="flex-row mt-4 space-x-4">
        ...
        <View className=" border border-[#2A2B2F] rounded-2xl p-4 flex-1 ml-2">
          ...
          <View className="space-y-3">
            <View className="flex-row justify-between mb-3">
              <Text className="text-[#9CA3AF] text-xs">P/B</Text>
              <Text className="text-white text-xs font-semibold">{stock.metrics?.priceToBook || '-'}</Text>
            </View>
            <View className="flex-row justify-between mb-3">
              <Text className="text-[#9CA3AF] text-xs">ROE</Text>
              <Text className="text-white text-xs font-semibold">{stock.metrics?.roe ? `${stock.metrics.roe}%` : '-'}</Text>
            </View>
            <View className="flex-row justify-between mb-3">
              <Text className="text-[#9CA3AF] text-xs">Debt/Eq</Text>
              <Text className="text-white text-xs font-semibold">{stock.metrics?.debtToEquity || '-'}</Text>
            </View>
            <View className="flex-row justify-between">
              <Text className="text-[#9CA3AF] text-xs">Curr. Ratio</Text>
              <Text className="text-white text-xs font-semibold">{stock.metrics?.currentRatio || '-'}</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View className="border border-[#2A2B2F] rounded-2xl p-4 mt-4">
        ...
        <View className="flex-row flex-wrap">
          <View className="w-1/2 mb-4">
            <Text className="text-[#9CA3AF] text-xs mb-1">Annual Div.</Text>
            <Text className="text-white text-sm font-semibold">Rs {stock.annualDividend || '-'}</Text>
          </View>
          <View className="w-1/2 mb-4 pl-4 border-l border-[#2A2B2F]">
            <Text className="text-[#9CA3AF] text-xs mb-1">Frequency</Text>
            <Text className="text-white text-sm font-semibold">{stock.dividendFreq || '-'}</Text>
          </View>
          <View className="w-1/2">
            <Text className="text-[#9CA3AF] text-xs mb-1">Ex-Div Date</Text>
            <Text className="text-white text-sm font-semibold">{stock.exDividendDate || '-'}</Text>
          </View>
          <View className="w-1/2 pl-4 border-l border-[#2A2B2F]">
            <Text className="text-[#9CA3AF] text-xs mb-1">Pay Date</Text>
            <Text className="text-white text-sm font-semibold">{stock.payDate || '-'}</Text>
          </View>
        </View>
      </View>
