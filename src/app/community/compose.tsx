    ...
    <SafeAreaView className="flex-1 bg-app-bg" edges={['top']}>
      ...
      >
        <View className="flex-row items-center justify-between px-4 py-3 border-b border-app-border">
          ...
          <Text className="text-app-text text-[17px] font-bold">{isEdit ? 'Edit Post' : 'New Post'}</Text>
        ...
        >
          <View className="flex-row items-start pt-5 pb-4">
            <View
              className="w-11 h-11 rounded-full items-center justify-center mr-3 border border-app-border"
            ...
            <View className="flex-1">
              <Text className="text-app-text font-semibold text-[15px]">{displayName}</Text>
          ...
          <TextInput
            ...
            autoFocus={!isEdit}
            className="text-app-text text-[16px] leading-7 min-h-[160px] py-0"
          />

          <Text className="text-app-muted text-[12px] text-right mt-2 mb-4">
          ...
          {imageUri ? (
            ...
            <TouchableOpacity
              onPress={pickImage}
              className="mb-5 flex-row items-center justify-center py-4 rounded-xl border border-dashed border-app-border bg-app-card"
            >
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-5">
            {NEWS_CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  <Text className={`text-[12px] font-semibold ${active ? 'text-[#FF8A00]' : 'text-app-muted'}`}>
                    {cat}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <View className="bg-app-card border border-app-border rounded-xl p-3">
            <Text className="text-app-muted text-[11px] leading-5">
